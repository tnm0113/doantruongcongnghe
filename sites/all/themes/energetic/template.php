...
function energetic_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function energetic_menu_local_task($link, $active = FALSE) {
...
function energetic_comment_wrapper($content, $type = null) {
  static $node_type;
  if (isset($type)) $node_type = $type;
  return '<div id="comments">'. $content . '</div>';
}

function energetic_menu_local_tasks() {
  $output = '';
 ...
 * @ingroup themeable
 */
function energetic_button($element) {
...
*/
function energetic_img_assist_page($content, $attributes = NULL) {
